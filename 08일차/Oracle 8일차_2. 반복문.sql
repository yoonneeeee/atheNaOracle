-- 24.06.24 SQL 8일차_02. 오라클 인덱스 실습
...
--#4
-- 인덱스 생성하기
CREATE INDEX INX_CUSTOMER_USERnAME ON KH_CUSTOMER_TBL(USER_NAME);
--Index INX_CUSTOMER_USERNAME이(가) 생성되었습니다.
