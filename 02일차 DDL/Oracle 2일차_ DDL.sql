...
-- 1. 테이블에 컬럼 추가 : GRADE_DATE 컬럼 추가
ALTER TABLE USER_GRADE
ADD GRADE_DATE DATE;
-- 2. 테이블의 컬럼 삭제 : GRADE_DATE 컬럼 삭제
ALTER TABLE USER_GRADE
...
ALTER TABLE USER_GRADE
RENAME COLUMN REG_DATE TO GRADE_DATE;
